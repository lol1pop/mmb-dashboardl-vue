...
import {mapActions, mapState} from 'vuex'
  ...
  export default {
    ...
    data(){
      return {
        items: [
          { title: 'Главная', icon: 'mdi-home', link: '/dashboard' },
          // { title: 'Tables', icon: 'mdi-grid-large', link: '/tables' },
          { title: 'Notifications', icon: 'mdi-bell-outline', link: '/notifications' },
          { divider: true },
          { heading: 'ПОЛЬЗОВАТЕЛИ' },
          { title: 'Список', icon: 'mdi-account-multiple', link: '/allusers'},
          { title: 'Пользователь', icon: 'mdi-account-search', link: '/infousers'},
          { divider: true },
          { heading: 'ЗАЯВКИ' },
          { title: 'Заявка', icon: 'mdi-image-filter-none', link: '/request'},
        ],
        sidebarWidth: 240,
        sidebarMinWidth: 96
      }
